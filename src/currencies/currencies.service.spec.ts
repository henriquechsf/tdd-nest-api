...
describe('CurrenciesService', () => {
  ...
  describe('getCurrency()', () => {
    it('should be throw if repository throw', async () => {
      (repository.getCurrency as jest.Mock).mockRejectedValueOnce(
    ...
    it('should be return when repository return', async () => {
      (repository.getCurrency as jest.Mock).mockResolvedValueOnce(mockData);
  ...
  describe('createCurrency()', () => {
    ...
    it('should be return when repository return', async () => {
      (repository.createCurrency as jest.Mock).mockResolvedValueOnce(mockData);
  ...
  describe('updateCurrency()', () => {
    ...
    it('should be return when repository return', async () => {
      (repository.updateCurrency as jest.Mock).mockResolvedValueOnce(mockData);
